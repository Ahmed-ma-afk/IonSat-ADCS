function [gh] = loadigrfcoefemb(time)
...
load IGRFembCoefs.mat;


% % Check validity on time.
years = cell2mat({coefemb.year});
...
% outputs requested.
    ...
    lastgh = coefemb(lastepoch).gh;
    nextgh = coefemb(nextepoch).gh;
